...
// NewAPPointmentBackendAPI creates a new APPointmentBackend instance
func NewAPPointmentBackendAPI(spec *loads.Document) *APPointmentBackendAPI {
	return &APPointmentBackendAPI{
		...
		UsersGetRoleOfUserHandler: users.GetRoleOfUserHandlerFunc(func(params users.GetRoleOfUserParams) middleware.Responder {
			return middleware.NotImplemented("operation UsersGetRoleOfUser has not yet been implemented")
		}),
...
/*APPointmentBackendAPI API to TPO UADE (Aplicaciones Distribuidas) */
type APPointmentBackendAPI struct {
	spec            *loads.Document
	...
	// UsersGetRoleOfUserHandler sets the operation handler for the get role of user operation
	UsersGetRoleOfUserHandler users.GetRoleOfUserHandler
...
func (o *APPointmentBackendAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *APPointmentBackendAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *APPointmentBackendAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *APPointmentBackendAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *APPointmentBackendAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *APPointmentBackendAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *APPointmentBackendAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the APPointmentBackendAPI
func (o *APPointmentBackendAPI) Validate() error {
	...
	if o.UsersGetRoleOfUserHandler == nil {
		unregistered = append(unregistered, "users.GetRoleOfUserHandler")
	}
...
func (o *APPointmentBackendAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *APPointmentBackendAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *APPointmentBackendAPI) Authorizer() runtime.Authorizer {
...
func (o *APPointmentBackendAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *APPointmentBackendAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *APPointmentBackendAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the a p pointment backend API
func (o *APPointmentBackendAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *APPointmentBackendAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/v1/patients/{id}/appointments/{idAppointment}/cancel"] = patients.NewCancelAppoinmentForPatient(o.context, o.PatientsCancelAppoinmentForPatientHandler)

	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/v1/professionals/{id}/appointments/{idappointment}/cancel"] = professionals.NewCancelAppointmentProfessional(o.context, o.ProfessionalsCancelAppointmentProfessionalHandler)

	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/v1/patients/{id}/appointments/{idAppointment}/confirm"] = patients.NewConfirmAppointmentForPatient(o.context, o.PatientsConfirmAppointmentForPatientHandler)
	...
	o.handlers["GET"]["/v1/users/{id}/role"] = users.NewGetRoleOfUser(o.context, o.UsersGetRoleOfUserHandler)
...
func (o *APPointmentBackendAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *APPointmentBackendAPI) Init() {
	if len(o.handlers) == 0 {
		o.initHandlerCache()
	}
}
...
func (o *APPointmentBackendAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *APPointmentBackendAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
