...
import (
	...
	"github.com/appointment/http/appointment_client/users"
)

// Default a p pointment backend HTTP client.
...
// NewHTTPClient creates a new a p pointment backend HTTP client.
func NewHTTPClient(formats strfmt.Registry) *APPointmentBackend {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new a p pointment backend HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *APPointmentBackend {
...
// New creates a new a p pointment backend client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *APPointmentBackend {
	// ensure nullable parameters have default
	if formats == nil {
		formats = strfmt.Default
	}

	cli := new(APPointmentBackend)
...
// APPointmentBackend is a client for a p pointment backend
type APPointmentBackend struct {
...
func (c *APPointmentBackend) SetTransport(transport runtime.ClientTransport) {
