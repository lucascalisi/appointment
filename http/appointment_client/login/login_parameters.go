...
// WithCredentials adds the credentials to the login params
func (o *LoginParams) WithCredentials(credentials LoginBody) *LoginParams {
	o.SetCredentials(credentials)
	return o
}

// SetCredentials adds the credentials to the login params
func (o *LoginParams) SetCredentials(credentials LoginBody) {
